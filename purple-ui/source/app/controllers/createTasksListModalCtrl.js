 ...
 * @author - Deepty
 */
angular.module('rootApp').controller('createTasksListModalCtrl', function ($scope, $rootScope, params, $uibModalInstance, $uibModal, tasksService, appNotifyService) {
    ...
    function validateTaskList(taskList) {
        ...
        if (!taskList.name) {
            appNotifyService.error("Please enter task list name");
            return false;
        }
