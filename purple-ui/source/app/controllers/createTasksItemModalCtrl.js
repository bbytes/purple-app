/*
 * Task Item Modal Controller
 */
angular.module('rootApp').controller('createTasksItemModalCtrl', function ($scope, $rootScope, $uibModalInstance, $uibModal, params, tasksService, dropdownListService, projectService, appNotifyService) {
    ...
    if ($scope.taskItem !== null && $scope.taskItem !== undefined) {
