module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        clean: {
            build: {
                src: ['<%= grunt.config.get("buildPath") %>/*.html', '<%= grunt.config.get("buildPath") %>/app/*', '<%= grunt.config.get("buildPath") %>/assets/*']
            }
        },
        copy: {
            appHtml: {
            ...
            angularApp: {
                expand: true,
                cwd: 'source/',
                src: ['app/**', '!app/controllers/**', '!app/services/**', '!app/partials/**'],
                dest: '<%= grunt.config.get("buildPath") %>/'
            },
            bootstrapFonts: {
                expand: true,
        ...
        cachebreaker: {
            dev: {
                options: {
                    match: ['_bower.css','styles.css','_bower.js','_lib.js','app.js','controllers.js','services.js','filters.js','directives.js','partials.js'],
                },
                files: {
