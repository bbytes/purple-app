...
public interface StatusRepository extends MongoRepository<Status, String> {
	...
	List<Status> findByDateTimeBetweenAndProjectIn(Date startDate, Date endDate, List<Project> project);

	List<Status> findByDateTimeBetweenAndProjectInAndUserIn(Date startDate, Date endDate, List<Project> project,
			List<User> user);
