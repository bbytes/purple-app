...
public class SocialConnectController implements InitializingBean {
	...
	private String viewPath = "social/";
	...
	/**
	 * Sets the path to connection status views. Prepended to provider-specific
	 * views (e.g., "connect/facebookConnected") to create the complete view
	 * name. Defaults to "connect/".
	 * 
	 * @param viewPath
	 ...
	 * 
	 * @param providerId
	 *            the ID of the provider to show connection status
	 * @param request
	 *            the request
	 * @param model
	 *            the model
	 ...
	 *         connection status page if there is an error
	 */
	 ...
	 * @param error
	 *            the error parameter sent from the provider
	 * @param errorDescription
	 *            the error_description parameter sent from the provider
	 * @param errorUri
	 *            the error_uri parameter sent from the provider
	 * @param request
	 *            the request
	 * @return a RedirectView to the connection status page
	 */
	 ...
	 * 
	 * @param providerId
	 *            the provider ID to remove connections for
	 ...
	 * @return the view name of a page to display when the user isn't connected
	 *         to the provider
	 */
	 ...
	 * @param providerId
	 *            the ID of the provider to display the connection status for.
	 * @return the view name of a page to display when the user is connected to
	 *         the provider
	 */
